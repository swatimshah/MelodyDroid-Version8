...
//		startService(serviceIntent);
		...
		Intent serviceIntent = new Intent(getApplicationContext(), MDService.class);
		startService(serviceIntent);		
		...
		modifySearch.setLayoutParams(new LayoutParams(
		...
		if (MelodyDroidHelper.isSearchOptionSelected()) {
			...
			newSearch.setLayoutParams(new LayoutParams(
					LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
